...
void selective_scan_fwd_zohs_kernel(SSMParamsBase params) {
...
void selective_scan_fwd_zohs_launch(SSMParamsBase &params, cudaStream_t stream) {
        ...
        BOOL_SWITCH(params.is_variable_B, kIsVariableB, [&] {
            BOOL_SWITCH(params.is_variable_C, kIsVariableC, [&] {
                BOOL_SWITCH(params.z_ptr != nullptr , kHasZ, [&] {
                    ...
                    auto kernel = &selective_scan_fwd_zohs_kernel<Ktraits>;
...
void selective_scan_fwd_zohs_cuda(SSMParamsBase &params, cudaStream_t stream) {
    if (params.seqlen <= 128) {
        selective_scan_fwd_zohs_launch<32, 4, input_t, weight_t>(params, stream);
    } else if (params.seqlen <= 256) {
        selective_scan_fwd_zohs_launch<32, 8, input_t, weight_t>(params, stream);
    } else if (params.seqlen <= 512) {
        selective_scan_fwd_zohs_launch<32, 16, input_t, weight_t>(params, stream);
    } else if (params.seqlen <= 1024) {
        selective_scan_fwd_zohs_launch<64, 16, input_t, weight_t>(params, stream);
    } else {
        selective_scan_fwd_zohs_launch<128, 16, input_t, weight_t>(params, stream);
    }
}
